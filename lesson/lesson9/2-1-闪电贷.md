...
![](https://www.wtf.academy/_next/image?url=https%3A%2F%2Fstatic.wtf.academy%2Fimage%2F8a90d55395b90b58aea511da56d084e5.png&w=3840&q=75)
...
AAVE是去中心的借贷平台，它的Pool合约通过flashLoan()和flashLoanSimple()两个函数支持单资产和多资产的闪电贷。这里，我们仅利用flashLoan()实现单个资产（WETH）的闪电贷。
