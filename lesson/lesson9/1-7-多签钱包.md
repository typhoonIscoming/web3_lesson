...
4. checkSignatures()：检查签名和交易数据的哈希是否对应，数量是否达到门槛，若否，交易会revert。单个签名长度为65字节，因此打包签名的长度要长于或等于threshold * 65。调用了signatureSplit()分离出单个签名。这个函数的大致思路：
* 用ecdsa获取签名地址.
...
![](https://www.wtf.academy/_next/image?url=https%3A%2F%2Fstatic.wtf.academy%2Fimage%2Fdaa559dab537c516641996a5765abc53.png&w=3840&q=75)

2.  转账1 ETH到多签合约地址。

![](https://www.wtf.academy/_next/image?url=https%3A%2F%2Fstatic.wtf.academy%2Fimage%2F541cb39058d469693528a57b6b1117bf.png&w=3840&q=75)


3.  调用encodeTransactionData()，编码并计算向多签地址1转账1 ETH的交易哈希。
```sol
参数
...
![](https://www.wtf.academy/_next/image?url=https%3A%2F%2Fstatic.wtf.academy%2Fimage%2F39fb49b8c68adcae73566aeee80db187.png&w=3840&q=75)
...
```
![](https://www.wtf.academy/_next/image?url=https%3A%2F%2Fstatic.wtf.academy%2Fimage%2F1960a956efc18be8cdf3b328d78c7197.png&w=3840&q=75)


5. 调用execTransaction()函数执行交易，将第3步中的交易参数和打包签名作为参数传入。可以看到交易执行成功，ETH被转出多签。

![](https://www.wtf.academy/_next/image?url=https%3A%2F%2Fstatic.wtf.academy%2Fimage%2Ff9beb105454d1f56f99266c5a1485dc6.png&w=3840&q=75)
